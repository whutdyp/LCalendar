...
const static int LunarCalendarInfo[] = {
    ...
    0x0d520};
static NSArray *HeavenlyStems;         //天干表
static NSArray *EarthlyBranches;       //地支表
static NSArray *LunarZodiac;           //生肖表
static NSArray *SolarTerms;            //24节气表
static NSArray *arrayMonth;            //农历月表
static NSArray *arrayDay;              //农历天表
static NSArray *arrayChineseDay;       //中国节日

@implementation LunarCalendar

+ (void)initStaticDataSource
{
    HeavenlyStems = @[@"甲",@"乙",@"丙",@"丁",@"戊",@"己",@"庚",@"辛",@"壬",@"癸"];
    EarthlyBranches = @[@"子",@"丑",@"寅",@"卯",@"辰",@"巳",@"午",@"未",@"申",@"酉",@"戌",@"亥"];
    LunarZodiac = @[@"鼠",@"牛",@"虎",@"兔",@"龙",@"蛇",@"马",@"羊",@"猴",@"鸡",@"狗",@"猪"];
    
    SolarTerms = @[@"立春", @"雨水", @"惊蛰", @"春分", @"清明", @"谷雨", @"立夏", @"小满", @"芒种", @"夏至", @"小暑", @"大暑", @"立秋", @"处暑", @"白露", @"秋分", @"寒露", @"霜降", @"立冬", @"小雪", @"大雪", @"冬至", @"小寒", @"大寒"];
    
    arrayMonth = @[@"正月", @"二月", @"三月", @"四月", @"五月", @"六月", @"七月", @"八月", @"九月",  @"十月", @"冬月", @"腊月"];
    
    arrayDay = @[@"初一", @"初二", @"初三", @"初四", @"初五", @"初六", @"初七", @"初八", @"初九", @"初十", @"十一", @"十二", @"十三", @"十四", @"十五", @"十六", @"十七", @"十八", @"十九", @"二十", @"廿一", @"廿二", @"廿三", @"廿四", @"廿五", @"廿六", @"廿七", @"廿八", @"廿九", @"三十", @"三一"];
    
    arrayChineseDay = @[@"春节",@"元宵",@"端午",@"七夕",@"中秋",@"重阳"];
}

#pragma mark -life cycle
-(id)init
{
    [LunarCalendar initStaticDataSource];
    self = [super init];
    if (self) {
...
- (NSString *)ChineseFestival
{
    //1.1春节 1.15元宵 5.5端午 7.7七夕 8.15中秋 9.9重阳
    chineseDay = nil;
    switch (lunarMonth) {
        case 1:
        {
            if (1 == lunarDay) {
                chineseDay = [arrayChineseDay objectAtIndex:0];
            }
            if (15 == lunarDay) {
                chineseDay = [arrayChineseDay objectAtIndex:1];
            }
        }
            break;
        case 5:
        {
            if (5 == lunarDay) {
                chineseDay = [arrayChineseDay objectAtIndex:2];
            }
        }
            break;
        case 7:
        {
            if (7 == lunarDay) {
                chineseDay = [arrayChineseDay objectAtIndex:3];
            }
        }
            break;
        case 8:
        {
            if (15 == lunarDay) {
                chineseDay = [arrayChineseDay objectAtIndex:4];
            }
        }
            break;
        case 9:
        {
            if (9 == lunarDay) {
                chineseDay = [arrayChineseDay objectAtIndex:5];
            }
        }
            break;
        default:
